...
public class GamificationSecurityConfig {
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		...
		http.authorizeHttpRequests().requestMatchers("/").permitAll().requestMatchers("/confirmAccount").permitAll()
				.requestMatchers("/recovery/*").anonymous().requestMatchers("/register/*").anonymous()
				.requestMatchers("/userdata/*").hasRole("USER").requestMatchers("/deleteConfirm").permitAll()
				.requestMatchers("/admin/*").hasRole("ADMIN").requestMatchers("/account/*").hasRole("USER")
				.requestMatchers("/menu").hasRole("USER").requestMatchers("/quest/*").hasRole("USER")
				.requestMatchers("/leaderboard/*").hasRole("USER").requestMatchers("/profile/*").hasRole("USER")
				.requestMatchers("/user-photos/*").permitAll().requestMatchers("badge-photos/*").permitAll()
	...
	// authentication provider which uses the custom UserService and a
